...
*/
var buildBridge = TRUE
var playerCount:Int = 50
var waterLevel:Float = 7.5
var fallenPlayer: String = "Oh noooo!"
...
*/
// variable names have been changed to avoid reuse (from above questions)
...
*/
var name = "Catherine Reyto"
var age = 33
"Your name is \(name), aged \(age)"
...
*/
var familyMembers = ["Thomas", "Debby", "Alex", "Nick"]
...
*/
var playerLives1 = ["builders", "climbers", "runners", "diggers"]
var playerLives2 = ["fire Throwers", "programmers", "acrobats"]
var allPlayerLives = playerLives1 + playerLives2

allPlayerLives += ["magician"]
allPlayerLives.count
...
var itsRaining = true
var bikingHome = true
if itsRaining && bikingHome {
   "I'll get caught in the rain"
} else {
    !itsRaining && bikingHome
    "I won't"
} 
/*:
## Loops
...
*/
var famousPeople = ["Molly Ringwald", "Julia Roberts", "Lindsay Lohan", "Natalie Portman"]
...
var counter = 0
while true {
    println("You have (counter) lives to save")
    ++counter
    if counter == 100 {
        break
    }
...
// THIS REALLY DOENS'T APPEAR RIGHT
/*:
## Switch case
...
*/
let favouriteThings = 5

switch favouriteThings {
case 0...1:
    println("Hats")
case 2...3:
    println("Bunnies")
case 4...5:
    println("elbows")
default:
    println("What random stuff do you like?")
}
...
*/
func favoriteThing(game: String) {
    println("My favourite cat is Hudson")
}
...
*/
func howWasTheAssignment(name: String) -> Bool {
    if name == "Boolian" {return true}
    if name == "Conditionals" {return true}
    if name == "Loops" {return false}
    if name == "While loops" {return false}
    if name == "Functions" {return false}
    return false
}

if howWasTheAssignment("Boolian") {
    println("This part was good")
} else {
    println("Who needs Boolians anyway?")
}
if howWasTheAssignment("Conditionals") {
    println("Also pretty understandable")
} else {
    println("Life as love is unconditional")
}
if howWasTheAssignment("Loops") {
    println("I could always use more practice with these")
} else {
    println("I didn't find much I could do with the examples at hand") // WHY DOESN'T THIS PRINT WHEN IT'S RETURNED FALSE?
}
if howWasTheAssignment("Functions") {
    println("I was better at this but think it could be improved") // ALSO THIS? 
} else {
    println("Meh")
}
/*:
